    ...
    <div className="container-page py-16 sm:py-20">
      <div className="max-w-2xl">
        ...
        <p className="mt-3 text-ink-500">
          Have a question about an estate, a payment plan, or want to book an
          inspection? Reach us directly or send a message below.
        </p>
      </div>
        ...
        <div className="lg:col-span-2">
          <div className="space-y-4">
            {details.map((d) => (
              <div
                key={d.label}
                className="flex items-start gap-4 rounded-2xl border border-navy-800/10 bg-white p-5">
          ...
          <div className="mt-6">
            <WhatsAppButton
              message="Hello Adashè-to-Plot, I have a question."
              className="w-full"
            />
          </div>
        </div>
